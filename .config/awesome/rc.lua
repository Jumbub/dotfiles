...
local maximal = io.popen("/home/jamie/scripts/theme"):read() == 'maximal'
...
beautiful.border_width  = maximal and 5 or 3
beautiful.border_normal = "#282923"
beautiful.border_focus  = maximal and "#fc961f" or "#16A085"
beautiful.border_marked = "#16A085"
beautiful.wallpaper         = "/home/jamie/.config/awesome/wallpaper.jpg"
beautiful.icon_theme        = "Papirus-Dark"
beautiful.useless_gap       = maximal and 5 or 0
beautiful.top_titlebar      = 2
beautiful.bg_normal         = maximal and "#222D3277" or "#222D32"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = maximal and "bottom" or "top", screen = s, height = 16,
      border_width = 0, opacity = maximal and 0.9 or 1
    })
...
for s = 1, screen.count() do screen[s]:connect_signal("arrange", function ()
  ...
  for _, c in pairs(clients) do
    ...
    if c.maximized then
      ...
      c.border_width = maximal and 5 or 2
