...
local theme = lush(function()
  return {
    ...
    Normal       { bg = getColor('BLACK'), fg = getColor('WHITE') }, -- normal text
    ...
    Constant       { fg = getColor('ORANGE') }, -- (preferred) any constant
    String         { fg = getColor('YELLOW')}, --   a string constant: "this is a string"
    ...
    Special        { fg = getColor('RED') }, -- (preferred) any special symbol
