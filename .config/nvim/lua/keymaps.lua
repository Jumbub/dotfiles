...
vim.api.nvim_set_keymap('n', '<leader>p',
                        ...
                        {silent = true}) -- Fuzzy find session
...
-- UUID
vim.api.nvim_set_keymap('n', '<leader>uu', 'i<C-r>=system("uuid")<CR><ESC>',
                        {silent = true})
vim.api.nvim_set_keymap('v', '<leader>uu', 'c<C-r>=system("uuid")<CR><ESC>',
                        {silent = true})
